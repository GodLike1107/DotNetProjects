    ...
    public partial class InitialCreateFixed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "john@example.com", "John Provider", "Provider" },
                    { 2, "jane@example.com", "Jane Customer", "Customer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pet Care", "Professional dog walking service in your neighborhood", 25.00m, 1, "Dog Walking" },
                    { 2, "Education", "High school and college level math tutoring", 40.00m, 1, "Math Tutoring" }
                });
